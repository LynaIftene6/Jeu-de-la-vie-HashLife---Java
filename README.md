...
* Simulation optimisée (HashLife)
* Multithreading pour de meilleures performances
* Benchmark intégré
...
```bash
git clone https://github.com/LynaIftene6/Jeu-de-la-vie-HashLife---Java.git
cd Jeu-de-la-vie-HashLife---Java
